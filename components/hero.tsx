...
export function Hero() {
  return (
    <section className="relative isolate min-h-[720px] overflow-hidden bg-[#0B4A2B] text-white md:min-h-[740px] lg:h-[760px] lg:min-h-0">
      <Image
      ...
      <div className="relative mx-auto grid h-full min-h-[720px] w-full max-w-[1320px] items-center px-5 pb-14 pt-[118px] sm:px-8 md:min-h-[740px] md:px-10 lg:min-h-0 lg:grid-cols-[1.08fr_.92fr] lg:px-12 lg:pb-12 lg:pt-[112px] xl:px-16">
        <div className="animate-hero relative z-20 max-w-[700px] self-center lg:pb-5">
        ...
        <div className="pointer-events-none relative hidden h-[560px] lg:block">
          <div className="absolute inset-y-0 -right-14 w-[620px] xl:-right-8 xl:w-[650px]">
            <div className="absolute bottom-[16%] right-[9%] h-[260px] w-[390px] rounded-full bg-black/20 blur-[48px]" />
            <Image
          ...
          <div className="absolute bottom-[70px] right-0 w-[245px] border border-white/45 bg-[#FBF5E7]/90 px-5 py-4 text-[#183223] shadow-[0_14px_34px_rgba(0,0,0,.16)] backdrop-blur-xl xl:right-2">
